...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--span_lr", type=float, default=1e-2, help="span_learning rate")
    parser.add_argument("--span_match_lr", type=float, default=3e-2, help="span_match_learning rate")
