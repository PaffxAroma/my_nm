...
class MRCNERDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        type2id={'Model': 0, 'Missile':1, 'method': 2, 'parameter': [], 'phenomenon': [],
         'process': []}
        ...
        # # print(context)
        # # lenc=len(context)
        # # if context[0:11]=='在巡航导弹武器控制系统':
        # #     print('found')
        # #     print(context[170:185])
        # new_end_positions = [origin_offset2token_idx_end[end] for end in end_positions]
        new_start_positions=[]
        new_end_positions=[]
        for start,end in zip(start_positions,end_positions):
            while end not in origin_offset2token_idx_end:
                end+=1
        ...
        for start, end in zip(new_start_positions, new_end_positions):
            ...
            #m1=match_labels[start, end]
            #print(m1)
            #print(match_labels[start].cpu().numpy())
...
def run_dataset():
    ...
    # json_path = "/mnt/mrc/zh_msra1/mrc-ner.test"
